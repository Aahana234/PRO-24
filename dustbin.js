class Dustbin{
    constructor(){
        ...
        this.wall1 = Bodies.rectangle(1200,335,500,20,options);
        this.wall2 = Bodies.rectangle(1000,330,700,20,options);
        this.wall3 = Bodies.rectangle(1100,400,20,200,options);
